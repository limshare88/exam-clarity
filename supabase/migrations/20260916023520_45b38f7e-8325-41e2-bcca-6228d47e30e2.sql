-- Mika gets her own set of purchasable backgrounds, same pattern as Leo's set added
-- earlier: Study Room, Street View, Cherry Blossom Cafe, Theme Park. Her 5th, the school
-- courtyard, isn't a catalog item -- it's her per-character default scene (see
-- BackgroundScenes.tsx's DEFAULT_BACKGROUNDS), same as Leo's playground.
--
