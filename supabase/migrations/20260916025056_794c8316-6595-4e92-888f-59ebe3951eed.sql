-- Pip gets his own set of purchasable backgrounds, same pattern as Leo's and Mika's:
-- Server Room, Retro Toy Store, Space Greenhouse, Neon Cyber City. His 5th, the robot
-- workshop, isn't a catalog item -- it's his per-character default scene (see
-- BackgroundScenes.tsx's DEFAULT_BACKGROUNDS), same as the other two.
--
